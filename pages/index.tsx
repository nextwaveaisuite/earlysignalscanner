...
export default function Home(){
  const { data } = useSWR('/api/alerts', fetcher, { refreshInterval: 8000 });
    ...
    <div className="wrap">
      ...
      <div className="grid">
        ...
        <div className="card">
          <h2>Status</h2>
          <ul>
            <li>Mock ingestion: <code>/api/ingest/mock</code></li>
            <li>Paper trades auto-close route prepared</li>
            <li>Cron examples in <code>vercel.json</code></li>
          </ul>
        </div>
      </div>
    </div>
